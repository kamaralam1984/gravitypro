...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: 24, fontWeight: '800', color: Colors.textWhite, marginTop: 4 },
  headerSub: { fontSize: 13, color: Colors.textSecondary, marginTop: 2 },
  scroll: { padding: 16, gap: 14 },
  card: { borderRadius: 18, overflow: 'hidden', borderWidth: 1, borderColor: Colors.border },
  cardGrad: { flexDirection: 'row', alignItems: 'center', gap: 14, padding: 16 },
  iconWrap: { width: 48, height: 48, borderRadius: 14, alignItems: 'center', justifyContent: 'center', backgroundColor: Colors.bgGlass, borderWidth: 1, borderColor: Colors.border },
  cardTitle: { fontSize: 16, fontWeight: '700', color: Colors.textPrimary },
  cardDesc: { fontSize: 12.5, color: Colors.textMuted, marginTop: 3 },
})
